...
sealed class PostBlockState(open val content: String) {
    ...
    data class IMAGE(override val content: String = "", val uri: Uri, val position: PositionState, val address: String = "") : PostBlockState(content)
    data class VIDEO(override val content: String = "", val uri: Uri, val position: PositionState, val address: String = "") : PostBlockState(content)
}
